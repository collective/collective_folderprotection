...
class TestRenameProtect(unittest.TestCase):
    ...
    def test_unable_to_rename_protected(self):
        self.assertRaises(Unauthorized, self.protected.manage_renameObjects, ['internal'], ['new-internal'])
        self.assertIn('internal', self.protected)
        self.assertNotIn('new-internal', self.protected)
        self.assertRaises(Unauthorized, self.portal.manage_renameObjects, ['protected'], ['new-protected'])
    ...
    def test_able_to_rename_disabled(self):
        ...
        self.portal.manage_renameObjects(['protected-disabled'], ['new-protected-disabled'])
